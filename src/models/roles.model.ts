export const ALL_MODULES = [
  ...
  {key: "certificates_cancellation", label: "Anulación de certificados" },
  { key: "certificates_basic", label: "Certificados (Básico)" },
...
export const HOME_PAGE_OPTIONS = [
  ...
  { key: "certificates_cancellation", label: "Anulación de certificados", path: "/certificates/cancellation" },
  { key: "certificates_basic", label: "Certificados (Básico)",  path: "/certificates/basic" },
